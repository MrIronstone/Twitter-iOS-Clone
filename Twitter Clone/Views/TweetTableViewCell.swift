...
class TweetTableViewCell: UITableViewCell {
    ...
    private let displayNameLabel: UILabel = {
        let label = UILabel()
        label.text = "Hüsamettin Demirtas"
    ...
    private let tweetTextContentLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam tempus dapibus quam non venenatis. Donec quam elit, varius nec placerat nec, suscipit vel ligula. Donec non rutrum nisi."
    ...
    private func configureConstraints() {
        ...
        let tweetTextContentLabelConstraints = [
            ...
            tweetTextContentLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -5),
        ]
